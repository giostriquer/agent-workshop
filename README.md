...
- `.claude/agents/` — seven working agent definitions (`doc-indexer`, `pattern-reviewer`, `spec-reviewer`, `research`, `vigil`, `visual-implementer`, `wiki-maintainer`).
- `.claude/skills/` — six working skills (`agent-audit`, `change-log`, `doc-audit`, `push`, `research`, `visual-advisor`).
